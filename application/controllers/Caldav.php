    ...
    public static function sync(string $provider_id): void
    {
        ...
        foreach ($local_events as $local_event) {
            ...
            try {
                ...
                // If CalDAV Calendar event is different from MarcaAgora appointment then update MarcaAgora record.
                ...
                // Appointment not found on CalDAV Calendar, delete from MarcaAgora.
        ...
        // Add CalDAV Calendar events that do not exist in MarcaAgora.
