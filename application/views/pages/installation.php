...
<head>
    ...
    <title>Installation | MarcaAgora</title>
...
<header>
    <div class="container">
        <h1 class="page-title">MarcaAgora Installation</h1>
    </div>
</header>

<div class="content container h-100">
    <div class="welcome">
        <h3>Welcome to the MarcaAgora installation page.</h3>
        <p>
            This page will help you set the main settings of your MarcaAgora installation. You will be able to
            ...
            If you face any problems during the usage of MarcaAgora you can always check the
    ...
    <div class="mb-2">
        <h3>License</h3>
        MarcaAgora is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
        of MarcaAgora in any way <br> you agree with the terms described in the following url:
...
<footer>
    Feito Por <a href="https://marcaagora.com">MarcaAgora</a>
</footer>
