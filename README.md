<h1 align="center">
    <br>
    <a href="https://marcaagora.com">
        <img src="https://raw.githubusercontent.com/alextselegidis/easyappointments/develop/logo.png" alt="MarcaAgora" width="150">
    </a>
    <br>
    MarcaAgora
    <br>
...
**MarcaAgora** is a highly customizable web application that allows customers to book appointments with you
...
MarcaAgora will run smoothly with your existing website as it can be installed in a single folder of the
...
-   Open the browser on the MarcaAgora URL and follow the installation guide.

That's it! You can now use MarcaAgora at your will.
