...
> This page contains information about the CLI support of MarcaAgora.

### Introduction

Starting from v1.4.0 MarcaAgora has introduced CLI support, providing a set of useful utilities to use with your installation. 
...
This command will perform a CLI installation of MarcaAgora. 
