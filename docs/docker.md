...
Run the development containers of MarcaAgora with Docker and Docker Compose utility. Docker allows you to compose your application in microservices, so that you can easily get started with the local development.
...
A production image of MarcaAgora can be found at: https://github.com/alextselegidis/easyappointments-docker
